...
- (void)setBgColor:(NSString *)bgColor {
  if(!bgColor) {return;}
  _bgColor = bgColor;
   _photoImageView.backgroundColor = [RNPhotoView colorFromHexString:_bgColor];
  _tapView.backgroundColor = [RNPhotoView colorFromHexString:_bgColor];
  self.backgroundColor = [RNPhotoView colorFromHexString:_bgColor];
