...
import {Animated, Dimensions, Keyboard, Text, TextInput, TouchableWithoutFeedback, ViewPropTypes} from 'react-native';
import PropTypes from 'prop-types';
import SearchUnSelIcon from 'Wadi/src/icons/tabbar/tab_search_selected.png'
...
class Search extends Component {
  constructor(props) {
     ...
     * local variables
     */
    this.placeholder = this.props.placeholder || strings.Search;
    this.cancelTitle = this.props.cancelTitle || strings.Cancel;
...
const styles = {
  container: {
    ...
    height: containerHeight+(isIos() ? 0 : 10),
    flexDirection: 'row',
  ...
  input: {
    height: containerHeight - (isIos() ? 10 : 3),
    //paddingTop: 10,
    //paddingBottom: 10,
    //paddingRight: 20,
    borderColor: '#444',
...
Search.propTypes = {
  ...
  serachIconVisible:PropTypes.bool,
};
