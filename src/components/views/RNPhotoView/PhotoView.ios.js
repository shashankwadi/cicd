...
export default class PhotoView extends Component {
    ...
    render() {
        ...
        if (source && source.uri) {
            var {onLoadStart, onLoad, onLoadEnd, onProgress, onTap, onViewTap, onScale, bgColor, ...props} = this.props;
            ...
            var nativeProps = {
                ...
                bgColor: !!bgColor ? bgColor : '#ffffff' // send this should be six digit hex code #DO NOT USE THREE DIGIT
            };
